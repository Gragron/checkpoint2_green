...
class AddUser extends Component{
    ...
    paterno = e => this.setState({paterno: e.target.value });

    materno = e => this.setState({materno: e.target.value });
    
    edad = e => this.setState({edad: e.target.value });  
                ...
                <h1 className="AgregarUsuario-title">Agrega un Usuario</h1>
                    <form onSubmit={this.insertNewUser}>
                        <Row className= "AgregarUsuario-forms">
                            ...
                            <Input onChange={this.edad} type="text" s={2} placeholder="Apellido Edad" label="Edad"  />
                        </Row>
